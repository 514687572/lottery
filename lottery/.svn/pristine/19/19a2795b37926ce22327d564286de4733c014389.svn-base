...
public class TigerRoom {
	...
	public BigDecimal getMaxPeiMoney() {
		BigDecimal pei_long0 = put_long0.multiply(new BigDecimal(TigerOption.long0.getPei())).add(put_long0);
		BigDecimal pei_long1 = put_long1.multiply(new BigDecimal(TigerOption.long0.getPei())).add(put_long1);
		BigDecimal pei_long2 = put_long2.multiply(new BigDecimal(TigerOption.long0.getPei())).add(put_long2);
		BigDecimal pei_hu0 = put_hu0.multiply(new BigDecimal(TigerOption.long0.getPei())).add(put_hu0);
		BigDecimal pei_hu1 = put_hu1.multiply(new BigDecimal(TigerOption.long0.getPei())).add(put_hu1);
		BigDecimal pei_hu2 = put_hu2.multiply(new BigDecimal(TigerOption.long0.getPei())).add(put_hu2);
		BigDecimal pei_he = put_he.multiply(new BigDecimal(TigerOption.long0.getPei())).add(put_he);
