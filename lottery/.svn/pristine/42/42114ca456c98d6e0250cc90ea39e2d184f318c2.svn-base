...
public class LotteryRecords extends BaseModel<Long> implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", hashOne=").append(hashOne);
        sb.append(", hashTwo=").append(hashTwo);
        sb.append(", hashThree=").append(hashThree);
        sb.append(", hashFour=").append(hashFour);
        sb.append(", hashFive=").append(hashFive);
    ...
    public boolean equals(Object that) {
        ...
        LotteryRecords other = (LotteryRecords) that;
        return (this.getRecordsId() == null ? other.getRecordsId() == null : this.getRecordsId().equals(other.getRecordsId()));
    }
