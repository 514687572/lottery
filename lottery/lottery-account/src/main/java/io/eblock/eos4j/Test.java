...
public class Test {
	...
	public static void main(String[] args){
		...
		String pk = Ecc.seedPrivate("zhangliang");///5Jccn7WQ6h2g1AZax4TYy3K18Li9aBynPEfdq4dbBH3ZkhK2y3i
...
//		Rpc rpc = new Rpc("http://47.106.221.171:8888");
		...
		try {
			Transaction t3 = rpc.createAccount("5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3","eosio","fdsa..54321", "EOS8eAX54cJtAngV2V22WZhRCW7e4sTAZz1mC5U22vp8mAGuFdMXx","EOS8eAX54cJtAngV2V22WZhRCW7e4sTAZz1mC5U22vp8mAGuFdMXx", 8192l);
