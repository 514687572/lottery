...
//        String userCode = user.getUserCode();
	 ...
	 * 我的下级列表（积分用户）
	 */
	@GetMapping("/getMyChild2.do")
	public Map<String, Object> getMyChild2(HttpServletRequest request) {
		...
		Map<String, Object> pageResult = lotteryUserService.getMyChild2(id, currentPage, pageSize);
		@SuppressWarnings("unchecked")
		List<Map<String, Object>> listData = (List<Map<String, Object>>) pageResult.get("data");
		for (int i = 0; i < listData.size(); i++) {
			Map<String, Object> line = listData.get(i);
			line.put("order", i + 1);
		}
		return pageResult;
	}
